  ...
  return (
    <div className="flex w-full flex-col items-start gap-4 lg:flex-row">
                  ...
                  >
                    ...
                    <div className="w-full space-y-0.5">
                      <div className="flex w-full items-center justify-between">
                        <p className="line-clamp-1 text-base leading-[155%] font-normal tracking-[0%] text-[#000000]">
                          {impact?.title}
                        </p>
                ...
                return (
                  <div className="rounded-[20px] border border-[#ECEFF3] bg-[#FFFFFF] p-6">
                    <div className="flex items-start gap-4" key={index}>
                      ...
                      <div className="w-full space-y-0.5">
                        <div className="flex w-full items-center justify-between">
                          <p className="text-base leading-[155%] font-normal tracking-[0%] text-[#000000]">
                            {impact?.title}
                          </p>
                          <p className="text-base leading-[155%] font-normal tracking-[0%] text-[#9C9C9C]">
                            {impact?.period}
      ...
      <div className="w-full space-y-3 lg:w-[45%]">
        ...
        <div className="h-[445px] rounded-[10px] bg-[#F6FAF9] p-4.5">
          <p className="mb-4 flex items-center justify-between border-b border-b-[#D7D7D7] pb-2 text-lg leading-[155%] font-medium tracking-[0%] text-[#000000]">
            Action
            <div>
