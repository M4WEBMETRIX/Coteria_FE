  ...
  return (
    <>
      <div className="mx-auto h-full w-full space-y-8">
        <div className="h-full items-start gap-8 lg:flex">
          {/* Left Sidebar - Profile Summary */}
          <div className="mb-6 flex h-full w-full shrink-0 flex-col justify-between lg:mb-0 lg:w-[300px]">
            ...
            <div className="mb-8 space-y-4 rounded-[16px] border border-[#ECEFF3] bg-white p-4">
              <div
                onClick={() => navigate("/user/dashboard?tab=impact")}
                className="flex cursor-pointer items-center justify-between border-b pb-4"
              >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-lg leading-[155%] font-normal tracking-[-2%] text-[#515151]">
                    ...
                    to track and download receipts for all your tax exempt donations made in the
                    past.
                  </p>
                </div>
              </div>
