...
import UserAuthCarousel from "./user-auth-carousel";
      ...
      <aside className="no-scrollbar w-full max-w-151.5 overflow-y-auto p-4">
        <div className="p-7.5">
          ...
          <div className="mt-12.5">
            <p className="text-5xl leading-[120%] font-bold tracking-[-2%]">
              {isReferrer ? "Invitation" : "Level Up Your Learning Journey"}
            </p>
            <p className="mt-3 leading-[160%] tracking-[0%] text-[#6F6F6F]">
              {isReferrer
                ? "You are referred by:"
          ...
          {isReferrer ? (
            ...
            <Button
              variant="outline"
              className="mt-5 h-16 w-full border-gray-300 leading-[155%] tracking-[0%] hover:bg-gray-50"
              type="button"
            >
