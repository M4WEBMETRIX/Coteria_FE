                ...
                <div className='flex-1 flex items-center justify-center h-screen overflow-auto'>
                    <div className='w-full h-full grid place-content-center'>
                        <div className='w-full'>
                            ...
                            <p className='text-[#414143] text-base leading-[140%] tracking-[0%] mb-12.5 text-center px-4'>
                                Sign in to manage your campaigns, track
                                community engagement, and view impact insights.
                            </p>
                            ...
                            <form
                                ...
                                <div className='flex justify-start text-base font-normal'>
                                    <p className=' text-[#414143]'>
                                        ...
                                        <Link
                                            ...
                                            className='text-[#12AA5B] hover:underline font-normal'>
                                            Reset password
                                        </Link>
                                    </p>
                                </div>
                                ...
                                <Button
                                    ...
                                    disabled={!isValid}
                                    type='submit'
                                    className='w-full bg-[#12AA5B] hover:bg-green-600 text-white font-semibold py-6 rounded-full text-base'>
