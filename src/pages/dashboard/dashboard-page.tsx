      ...
      content: (
        <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
          <div className='flex justify-between items-start mb-4'>
            <div>
              <h4 className='font-semibold text-gray-800'>ABC Community</h4>
              <p className='text-sm text-gray-500'>#1234567</p>
            </div>
            <div className='text-right'>
              <span className='text-xs text-gray-500 block'>Debit</span>
          ...
          <div className='space-y-3'>
            <div className='flex items-center space-x-3 p-2 bg-gray-50 rounded'>
              ...
              <div className='flex-1'>
                <p className='text-sm font-medium'>Blaise Cooper</p>
                <p className='text-xs text-gray-500'>blaise@coterie.me</p>
              </div>
            ...
            <div className='flex items-center space-x-3 p-2 bg-gray-50 rounded'>
              ...
              <div className='flex-1'>
                <p className='text-sm font-medium'>Mikaela Harry</p>
                <p className='text-xs text-gray-500'>mik@email.me</p>
              </div>
            </div>
          </div>
          <button className='mt-4 text-sm text-gray-600 flex items-center'>
            <span className='mr-2'>Donors</span>
            <span className='bg-gray-200 rounded px-2 py-0.5'>23</span>
          </button>
        </div>
      ),
    },
        ...
        <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
          ...
          <div className='flex justify-center space-x-2'>
            {['Daily', 'Weekly', 'Monthly'].map((freq) => (
              <button
                key={freq}
                onClick={() => setDonationFrequency(freq.toLowerCase())}
